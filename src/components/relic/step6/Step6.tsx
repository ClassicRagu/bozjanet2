    ...
    <>
      ...
      >
        ...
        <AccordionDetails>
          ...
          completed timeworns you have 2 steps that I would consider worthwhile
          and once again, it relies on if you want a solo clear of Heaven on
          High.
          <br />
          <br />
          If you do not want &quot;Lone Hero&quot; and don&quot;t want to grind more DRN,{" "}
          <i>The Dalriada</i> is for you. It drops 3 Raw Emotions per clear and
          in an active instance spawns around every 30 minutes or so.
          <br />
          <br />
          ...
          certainly is. We don&quot;t have perfect data on how Dal scales but it&quot;s
          very similar to CLL so feel free to check out the{" "}
          ...
          <br />
          <br />
          This is however, the perfect step for those who want to get the title &quot;Lone Hero&quot; as you can get progress towards this step and work towards a solo clear of Heaven on High at the same time.
        </AccordionDetails>
      </Accordion>
    </>
  );
