    ...
    <>
      ...
      >
        ...
        <AccordionDetails>
          ...
          <p>
            The alternative raids are almost never worth it for the Skirmish
            items but it&apos;s a completely different story for the CE items.
            Due to the frequency of CEs spawning being quite low on average, it
            can be a better use of your time to do the raids. If you end up
            completing the Skirmish items and still need CE ones, you can queue
            for the following raids:
            <ul>
              <li>
                Spare Parts:{" "}
            ...
            spawn almost all of the CEs in the instance so it may be worth
            trying to join the same instance as those farming to complete the CE
            items.
          </p>
        </AccordionDetails>
      </Accordion>
