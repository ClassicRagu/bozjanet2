        ...
        <TableRow key={`job-${index}`}>
          <TableCell>
            <Box
              ...
              src={`/relic/weapons/${job.jobAbv}/${job.jobName}.png`}
            />
          </TableCell>
          <TableCell>
            <IconBox
              step={0}
              job={index}
              relicImage={`/relic/weapons/${job.jobAbv}/${job.jobAbv}_1_HD.png`}
          ...
          <TableCell>
            <IconBox
              step={3}
              job={index}
              relicImage={`/relic/weapons/${job.jobAbv}/${job.jobAbv}_2_HD.png`}
          ...
          <TableCell>
            <IconBox
              step={5}
              job={index}
              relicImage={`/relic/weapons/${job.jobAbv}/${job.jobAbv}_3_HD.png`}
